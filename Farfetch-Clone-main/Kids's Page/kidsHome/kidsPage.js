...
shop.forEach((el)=>{
    el.addEventListener('click',function(){
        window.location.href = '../kidsOptions/kids.html'
    })
})
...
let products = JSON.parse(localStorage.getItem('kidsProducts'))
...
products = JSON.parse(localStorage.getItem('kidsProducts'))
